# Skill Registry — frontend-system-design-homework-uni
...
| `gentle-ai-bench` | Trigger: bench, journey, journeys, driven mode, gentle-ai-bench, journey corpus, j-numbers, bench axis. Author and verify gentle-ai bench journeys; go test ./bench never proves driven execution. | user | `/Users/enocgarciadev/.config/opencode/skills/gentle-ai-bench/SKILL.md` |
